...
import { imgUnsplashZuIdlSz3XLg } from "./svg-4k829";
...
function Button() {
  return (
    <div className="bg-[#aa0909] h-[56px] relative rounded-[16px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] shrink-0 w-[300px]" data-name="Button">
