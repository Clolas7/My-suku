...
import { imgUnsplashZuIdlSz3XLg } from "../imports/svg-9it49";
...
function Button({ onClick }: { onClick: () => void }) {
  return (
    <button onClick={onClick} className="absolute bg-[#aa0909] h-[56px] left-[32px] rounded-[16px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] top-[40px] w-[300px]" data-name="Button">
...
export default function WelcomePage1({ onNext }: { onNext: () => void }) {
  return (
