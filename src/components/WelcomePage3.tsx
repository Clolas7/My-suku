import imgUnsplashZuIdlSz3XLg1 from "figma:asset/7f8366626fa33e5754e52c0d85a4510da455f2fc.png";
...
import imgUnsplashTqOeGdRNowY from "figma:asset/320b1eeaa9adf5405314eaf63a8acebd1cf53198.png";
import { imgUnsplashZuIdlSz3XLg } from "../imports/svg-4k829";

function Heading() {
  return (
    <div className="absolute h-[24px] left-[116px] top-[318px] w-[127.448px]" data-name="Heading 2">
      <p className="absolute font-['Arial:Regular',sans-serif] leading-[24px] left-[64.5px] not-italic text-[16px] text-center text-nowrap text-white top-[-1.67px] translate-x-[-50%] whitespace-pre">Livraison Express</p>
    </div>
  );
}
...
function MaskGroup1() {
  return (
    <div className="absolute contents left-[312.43px] size-[113.137px] top-[151.78px]" data-name="Mask group">
      <div className="absolute flex items-center justify-center left-[276.72px] size-[170.873px] top-[127.87px]" style={{ "--transform-inner-width": "100", "--transform-inner-height": "142" } as React.CSSProperties}>
...
function Container2() {
  return (
    <div className="content-stretch flex gap-[8px] h-[8px] items-start justify-center relative shrink-0 w-full" data-name="Container">
...
function Button({ onClick }: { onClick: () => void }) {
  return (
    <button onClick={onClick} className="bg-[#aa0909] h-[56px] relative rounded-[16px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] shrink-0 w-[300px]" data-name="Button">
      <p className="absolute font-['Arial:Regular',sans-serif] leading-[20px] left-[149.5px] not-italic text-[14px] text-center text-nowrap text-white top-[18px] translate-x-[-50%] whitespace-pre">Commencer</p>
    </button>
  );
}

function Container3({ onStart }: { onStart: () => void }) {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[32px] h-[113px] items-start left-0 px-[32px] py-0 top-[557px] w-[360px]" data-name="Container">
      <Container2 />
...
export default function WelcomePage3({ onStart }: { onStart: () => void }) {
  return (
    <div className="bg-black relative rounded-[50px] size-full" data-name="Welcome page 3">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        ...
        <Heading />
        <p className="absolute font-['Arial:Regular',sans-serif] leading-[24px] left-[179.5px] not-italic text-[16px] text-center text-white top-[391px] translate-x-[-50%] w-[333px]">Suivi en temps réel et livraison rapide pour tous vos besoins</p>
