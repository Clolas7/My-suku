...
import imgUnsplashTqOeGdRNowY from "figma:asset/baca13b445ff2ee926d1a264800d69ca14bf3224.png";
import { imgUnsplashZuIdlSz3XLg } from "../imports/svg-iz3eh";

function Heading() {
  return (
    <div className="absolute h-[24px] left-[116px] top-[318px] w-[127.448px]" data-name="Heading 2">
      <p className="absolute font-['Arial:Regular',sans-serif] leading-[24px] left-[64.5px] not-italic text-[16px] text-center text-nowrap text-white top-[-1.67px] translate-x-[-50%] whitespace-pre">{`Courses & Plus`}</p>
    </div>
  );
}
...
function Container3({ onNext }: { onNext: () => void }) {
  return (
...
export default function WelcomePage2({ onNext }: { onNext: () => void }) {
  return (
    <div className="bg-black relative rounded-[50px] size-full" data-name="Welcome page 2">
      <div className="overflow-clip relative rounded-[inherit] size-full">
        ...
        <Heading />
        <p className="absolute font-['Arial:Regular',sans-serif] leading-[24px] left-[179.5px] not-italic text-[16px] text-center text-white top-[391px] translate-x-[-50%] w-[333px]">Commandez vos courses, médicaments et bien plus encore en quelques clics</p>
